...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2018 at 10:23 AM
...
CREATE TABLE `tblactivity` (
  `act_id` int(11) NOT NULL COMMENT 'ลำดับ',
  `act_name` varchar(300) NOT NULL COMMENT 'ชื่อกิจกรรม',
  `act_locid` int(2) NOT NULL COMMENT 'สถานที่จัด',
  `act_force_year1` int(2) DEFAULT NULL COMMENT 'กิจกรรมบังคับปี 1',
  `act_force_year2` int(2) DEFAULT NULL COMMENT 'กิจกรรมบังคับปี 2',
  `act_force_year3` int(2) DEFAULT NULL COMMENT 'กิจกรรมบังคับปี 3',
  `act_force_year4` int(2) DEFAULT NULL COMMENT 'กิจกรรมบังคับปี 4',
  `act_select_year1` int(2) DEFAULT NULL COMMENT 'กิจกรรมเลือกปี 1',
  `act_select_year2` int(2) DEFAULT NULL COMMENT 'กิจกรรมเลือกปี 2',
  `act_select_year3` int(2) DEFAULT NULL COMMENT 'กิจกรรมเลือกปี 3',
  `act_select_year4` int(2) DEFAULT NULL COMMENT 'กิจกรรมเลือกปี 4',
  `act_useid` int(11) NOT NULL COMMENT 'ผู้จัดกิจกรรม',
  `act_datestart` date NOT NULL COMMENT 'วันที่จัดกิจกรรม',
  `act_dateend` date NOT NULL COMMENT 'วันที่สิ้นสุดกิจกรรม',
  `act_check` tinyint(2) DEFAULT NULL COMMENT 'กำหนดจำนวนเช็คชื่อ',
  `act_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `act_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `act_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `act_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `act_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
...
INSERT INTO `tblactivity` (`act_id`, `act_name`, `act_locid`, `act_force_year1`, `act_force_year2`, `act_force_year3`, `act_force_year4`, `act_select_year1`, `act_select_year2`, `act_select_year3`, `act_select_year4`, `act_useid`, `act_datestart`, `act_dateend`, `act_check`, `act_createby`, `act_createtime`, `act_updateby`, `act_updatetime`, `act_status`) VALUES
(1, 'ปฐมนิเทศนักศึกษาใหม่ระดับมหาวิทยาลัย ประจำปี 2560', 1, 4, 0, 0, 0, 0, 3, 2, 1, 1, '2018-04-09', '2018-04-13', 3, 'admin', '2018-04-10', 'admin', '2018-04-30', 1),
(2, 'พิธีไหว้ครูนักศึกษาภาคปกติ ประจำปี 2560', 1, 0, 3, 2, 0, 4, 0, 0, 0, 1, '2018-04-10', '2018-04-21', 3, 'admin', '2018-04-10', 'admin', '2018-05-01', 1),
(3, '	ปฐมนิเทศนักศึกษาใหม่ระดับมหาวิทยาลัย ประจำปี 2561', 1, 4, 0, 0, 0, 0, 3, 2, 1, 1, '2018-04-20', '2018-04-22', 3, 'admin', '2018-04-20', 'admin', '2018-04-20', 1),
(4, 'พิธีไหว้ครูนักศึกษาภาคปกติ ประจำปี 2561', 1, 4, 0, 0, 0, 0, 0, 0, 0, 1, '2018-04-20', '2018-04-20', 2, 'admin', '2018-04-20', 'admin', '2018-04-30', 1),
(5, 'กิจกรรมกีฬาภายใน ประจำปี 2561', 1, 0, 3, 0, 0, 4, 0, 0, 0, 1, '2018-04-29', '2018-05-09', 5, 'admin', '2018-04-20', 'admin', '2018-04-30', 1);
...
CREATE TABLE `tblbranch` (
  `bran_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `bran_name` varchar(200) NOT NULL COMMENT 'ชื่อสาขา',
  `bran_num` varchar(5) DEFAULT NULL COMMENT 'รหัสสาขา',
  `bran_courid` int(2) NOT NULL COMMENT 'เลขหลักสูตร',
  `bran_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `bran_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `bran_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `bran_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `bran_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='สาขา';

--
-- Dumping data for table `tblbranch`
--

INSERT INTO `tblbranch` (`bran_id`, `bran_name`, `bran_num`, `bran_courid`, `bran_createby`, `bran_createtime`, `bran_updateby`, `bran_updatetime`, `bran_status`) VALUES
(1, 'การศึกษาปฐมวัย', '101', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(2, 'วิทยาศาสตร์ทั่วไป', '106', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(3, 'สังคมศึกษา', '110', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(4, 'คณิตศาสตร์', '136', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(5, 'ภาษาอังกฤษ', '137', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(6, 'ภาษาไทย', '138', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(7, 'พลศึกษา', '139', 1, 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(8, 'วิทยาการคอมพิวเตอร์', '325', 2, 'admin', '2018-04-10', 'admin', '2018-04-10', 1);
...
CREATE TABLE `tblcheck` (
  `chk_id` int(11) NOT NULL COMMENT 'ลำดับ',
  `chk_actid` int(11) DEFAULT NULL COMMENT 'ID กิจกรรม',
  `chk_stuid` varchar(30) DEFAULT NULL COMMENT 'ID นศ',
  `chk_preid` varchar(30) DEFAULT NULL COMMENT 'ID เจ้าหน้าที่',
  `chk_date` datetime DEFAULT NULL COMMENT 'วันที่เช็คกิจกรรม',
  `chk_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `chk_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `chk_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `chk_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `chk_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเช็คชื่อกิจกรรม';

--
-- Dumping data for table `tblcheck`
--

INSERT INTO `tblcheck` (`chk_id`, `chk_actid`, `chk_stuid`, `chk_preid`, `chk_date`, `chk_createby`, `chk_createtime`, `chk_updateby`, `chk_updatetime`, `chk_status`) VALUES
(1, 1, '60123250123', 'admin', '2018-04-10 10:22:36', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(2, 1, '57123250117', 'admin', '2018-04-10 11:10:20', 'admin', '2018-04-10', 'admin', '2018-04-10', 3),
(3, 1, '57123250118', 'admin', '2018-04-10 11:09:26', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(4, 2, '57123250117', 'admin', '2018-04-10 11:13:17', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(5, 2, '57123250118', 'admin', '2018-04-20 12:02:20', 'admin', '2018-04-20', 'admin', '2018-04-20', 1),
(6, 2, '57123250101', 'admin', '2018-04-20 12:03:14', 'admin', '2018-04-20', 'admin', '2018-04-20', 1),
(7, 3, '60123250123', 'admin', '2018-04-20 12:05:03', 'admin', '2018-04-20', 'admin', '2018-04-20', 1);
...
CREATE TABLE `tblcourse` (
  `cour_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `cour_name` varchar(30) NOT NULL COMMENT 'ชื่อหลักสูตร',
  `cour_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `cour_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `cour_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `cour_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `cour_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางหลักสูตร';

--
-- Dumping data for table `tblcourse`
--

INSERT INTO `tblcourse` (`cour_id`, `cour_name`, `cour_createby`, `cour_createtime`, `cour_updateby`, `cour_updatetime`, `cour_status`) VALUES
(1, 'ครุศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(2, 'วิทยาศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(3, 'ศิลปศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(4, 'บริการธุรกิจบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(5, 'บัญชี', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(6, 'เทคโนโลยีบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(7, 'รัฐประศาสนศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(8, 'นิติศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(9, 'นิเทศศาสตรบัณฑิต', 'admin', '2018-04-10', 'admin', '2018-04-10', 1);
...
CREATE TABLE `tbldegree` (
  `deg_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `deg_name` varchar(100) NOT NULL COMMENT 'ระดับการศึกษา',
  `deg_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `deg_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `deg_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `deg_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `deg_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ระดับการศึกษา';

--
-- Dumping data for table `tbldegree`
--

INSERT INTO `tbldegree` (`deg_id`, `deg_name`, `deg_createby`, `deg_createtime`, `deg_updateby`, `deg_updatetime`, `deg_status`) VALUES
(1, 'อนุปริญญา', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(2, 'ปริญญาตรี 4 ปี', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(3, 'ปริญญาตรี 2 ปี', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(4, 'ปริญญาตรี 5 ปี', 'admin', '2018-04-09', 'admin', '2018-04-09', 1);
...
CREATE TABLE `tblfaculty` (
  `fac_id` int(2) NOT NULL COMMENT 'ลำดับคณะ',
  `fac_name` varchar(200) DEFAULT NULL COMMENT 'ชื่อคณะ',
  `fac_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `fac_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `fac_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `fac_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `fac_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางคณะ';

--
-- Dumping data for table `tblfaculty`
--

INSERT INTO `tblfaculty` (`fac_id`, `fac_name`, `fac_createby`, `fac_createtime`, `fac_updateby`, `fac_updatetime`, `fac_status`) VALUES
(1, 'ครุศาสตร์', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(2, 'เทคโนโลยีอุตสาหกรรม', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(3, 'มนุษยศาสตร์และสังคมศาสตร์', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(4, 'วิทยาการจัดการ', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(5, 'วิทยาศาสตร์และเทคโนโลยี', 'admin', '2018-04-09', 'admin', '2018-04-09', 1);
...
CREATE TABLE `tbllocation` (
  `loc_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `loc_name` varchar(200) DEFAULT NULL COMMENT 'ชื่อสถานที่',
  `loc_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `loc_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `loc_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `loc_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `loc_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
...
INSERT INTO `tbllocation` (`loc_id`, `loc_name`, `loc_createby`, `loc_createtime`, `loc_updateby`, `loc_updatetime`, `loc_status`) VALUES
(1, 'อาคารอเนกประสงค์', 'admin', '2018-04-10', 'admin', '2018-04-10', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tblpreple`
--

CREATE TABLE `tblpreple` (
  `pre_id` varchar(30) NOT NULL COMMENT 'ลำดับ',
  `pre_titid` int(1) NOT NULL COMMENT 'คำนำหน้าชื่อ',
  `pre_name` varchar(150) NOT NULL COMMENT 'ชื่อ',
  `pre_lname` varchar(150) NOT NULL COMMENT 'นามสกุล',
  `pre_idcard` varchar(15) DEFAULT NULL COMMENT 'รหัสบัตรประชาชน',
  `pre_phone` varchar(10) DEFAULT NULL COMMENT 'เบอร์โทร',
  `pre_homeno` varchar(50) DEFAULT NULL COMMENT 'บ้านเลขที่',
  `pre_distid` int(5) DEFAULT NULL COMMENT 'ตำบล',
  `pre_ampid` int(5) DEFAULT NULL COMMENT 'อำเภอ',
  `pre_provid` int(5) DEFAULT NULL COMMENT 'จังหวัด',
  `pre_zipid` int(5) DEFAULT NULL COMMENT 'รหัสไปรษณีย์',
  `pre_bday` date DEFAULT NULL COMMENT 'วันเกิด',
  `pre_img` varchar(100) DEFAULT 'profile.png' COMMENT 'รูป',
  `pre_facid` int(2) DEFAULT NULL COMMENT 'คณะ',
  `pre_type` int(2) NOT NULL DEFAULT '2' COMMENT 'ประเภทผู้ใช้งาน 1.admin 2.เจ้าหน้าที่',
  `pre_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `pre_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `pre_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `pre_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `pre_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tblpreple`
--

INSERT INTO `tblpreple` (`pre_id`, `pre_titid`, `pre_name`, `pre_lname`, `pre_idcard`, `pre_phone`, `pre_homeno`, `pre_distid`, `pre_ampid`, `pre_provid`, `pre_zipid`, `pre_bday`, `pre_img`, `pre_facid`, `pre_type`, `pre_createby`, `pre_createtime`, `pre_updateby`, `pre_updatetime`, `pre_status`) VALUES
('12345678901', 1, 'บุคลา', 'กร', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '12345678901img.jpg', 5, 2, '12345678901', '2018-05-01', '12345678901', '2018-05-01', 1),
('admin', 1, 'ผู้ดูแล', 'ระบบ', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 5, 1, 'admin', '2018-04-09', 'admin', '2018-04-09', 1);
...
CREATE TABLE `tblstudent` (
  `stu_id` varchar(30) NOT NULL COMMENT 'username',
  `stu_titid` int(1) NOT NULL COMMENT 'คำนำหน้าชื่อ',
  `stu_name` varchar(150) NOT NULL COMMENT 'ชื่อ',
  `stu_lname` varchar(150) NOT NULL COMMENT 'นามสกุล',
  `stu_idcard` varchar(15) DEFAULT NULL COMMENT 'รหัสบัตรประชาชน',
  `stu_phone` varchar(11) DEFAULT NULL COMMENT 'เบอร์โทรศัพท์',
  `stu_bday` date DEFAULT NULL COMMENT 'วันเกิด',
  `stu_homeno` varchar(50) DEFAULT NULL COMMENT 'เลขที่บ้าน',
  `stu_distid` int(5) DEFAULT NULL COMMENT 'ตำบล',
  `stu_ampid` int(5) DEFAULT NULL COMMENT 'อำเภอ',
  `stu_provid` int(5) DEFAULT NULL COMMENT 'จังหวัด',
  `stu_zipid` int(5) DEFAULT NULL COMMENT 'รหัสไปรษณีย์',
  `stu_img` varchar(40) DEFAULT 'profile.png' COMMENT 'รูป',
  `stu_yearid` int(2) DEFAULT NULL COMMENT 'ปีที่เข้าศึกษา',
  `stu_tyeid` int(2) DEFAULT NULL COMMENT 'ประเภทการศึกษา',
  `stu_degid` int(2) DEFAULT NULL COMMENT 'ระดับการศึกษา',
  `stu_branid` int(2) DEFAULT NULL COMMENT 'สาขา',
  `stu_courid` int(2) DEFAULT NULL COMMENT 'หลักสูตร',
  `stu_facid` int(2) DEFAULT NULL COMMENT 'คณะ',
  `stu_classroom` varchar(50) DEFAULT NULL COMMENT 'หมู่เรียน',
  `stu_type` int(2) NOT NULL DEFAULT '3' COMMENT 'ประเภทผู้ใช้งาน เป็น นศ',
  `stu_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `stu_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `stu_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `stu_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `stu_status` tinyint(1) DEFAULT '1' COMMENT 'สถานะการศึกษา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='ตารางข้อมูลผู้ใช้งาน';

--
-- Dumping data for table `tblstudent`
--

INSERT INTO `tblstudent` (`stu_id`, `stu_titid`, `stu_name`, `stu_lname`, `stu_idcard`, `stu_phone`, `stu_bday`, `stu_homeno`, `stu_distid`, `stu_ampid`, `stu_provid`, `stu_zipid`, `stu_img`, `stu_yearid`, `stu_tyeid`, `stu_degid`, `stu_branid`, `stu_courid`, `stu_facid`, `stu_classroom`, `stu_type`, `stu_createby`, `stu_createtime`, `stu_updateby`, `stu_updatetime`, `stu_status`) VALUES
('57123250101', 1, 'ธนากร', 'ทับทอง', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 1, 1, 2, 8, 2, 5, '571232501', 3, '57123250101', '2018-04-10', '57123250101', '2018-04-10', 1),
('57123250117', 1, 'พงศ์พิชาญ', 'นิรมิตวสุ', '2709900022173', '0988738261', '1992-10-09', '328/41', 7009, 782, 56, 5844, 'profile.png', 1, 1, 2, 8, 2, 5, '571232501', 3, '57123250117', '2018-04-10', '57123250117', '2018-04-10', 1),
('57123250118', 1, 'test', 'test2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 1, 1, 2, 8, 2, 5, '571232501', 3, '57123250118', '2018-04-10', '57123250118', '2018-04-10', 1),
('58123250127', 1, 'ธีรพล', 'สังขไพรวรรณ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 2, 1, 2, 8, 2, 5, '581232501', 3, '58123250127', '2018-04-22', '58123250127', '2018-04-22', 1),
('59123250104', 3, 'Thitima', 'Yenprasop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 3, 1, 2, 8, 2, 5, '591232501', 3, '59123250104', '2018-04-10', '59123250104', '2018-04-10', 1),
('60123250123', 1, 'ณัฐพล', 'คุ้มกัน', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'profile.png', 4, 1, 2, 8, 2, 5, '601232501', 3, '60123250123', '2018-04-10', '60123250123', '2018-04-10', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbltittle`
--

CREATE TABLE `tbltittle` (
  `tit_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `tit_name` varchar(100) NOT NULL COMMENT 'ชื่อคำนำหน้า',
  `tit_createby` varchar(30) NOT NULL COMMENT 'สร้างโดย',
  `tit_createtime` date NOT NULL COMMENT 'วันที่สร้าง',
  `tit_updateby` varchar(30) NOT NULL COMMENT 'แก้ไขโดย',
  `tit_updatetime` date NOT NULL COMMENT 'วันที่แก้ไข',
  `tit_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางคำนำหน้าชื่อ';

--
-- Dumping data for table `tbltittle`
--

INSERT INTO `tbltittle` (`tit_id`, `tit_name`, `tit_createby`, `tit_createtime`, `tit_updateby`, `tit_updatetime`, `tit_status`) VALUES
(1, 'นาย', 'admin', '2018-03-11', 'admin', '2018-03-11', 1),
(2, 'นาง', 'admin', '2018-04-05', 'admin', '2018-04-05', 1),
(3, 'นางสาว', 'admin', '2018-04-05', 'admin', '2018-04-05', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbltype_education`
--

CREATE TABLE `tbltype_education` (
  `tye_id` int(2) NOT NULL COMMENT 'ลำดับ',
  `tye_name` varchar(100) DEFAULT NULL COMMENT 'ประเภทการศึกษา',
  `tye_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `tye_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `tye_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `tye_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `tye_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางประเภทการศึกษา';

--
-- Dumping data for table `tbltype_education`
--

INSERT INTO `tbltype_education` (`tye_id`, `tye_name`, `tye_createby`, `tye_createtime`, `tye_updateby`, `tye_updatetime`, `tye_status`) VALUES
(1, 'ภาคปกติ', 'admin', '2018-04-10', 'admin', '2018-04-10', 1),
(2, 'ภาคพิเศษโครงการ กศ.บป.มหาวิทยาลัยราชภัฏกาญจนบุรี', 'admin', '2018-04-10', 'admin', '2018-04-10', 1);
...
CREATE TABLE `tbluser` (
  `use_id` int(11) NOT NULL COMMENT 'ลำดับ',
  `use_user` varchar(30) DEFAULT NULL COMMENT 'username',
  `use_pass` varchar(150) DEFAULT NULL COMMENT 'password',
  `use_type` tinyint(1) DEFAULT NULL COMMENT 'ประเภทผู้ใช้งาน 1.บุคลากร 2.นศ',
  `use_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `use_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `use_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `use_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `use_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะการใช้งาน'
...
INSERT INTO `tbluser` (`use_id`, `use_user`, `use_pass`, `use_type`, `use_createby`, `use_createtime`, `use_updateby`, `use_updatetime`, `use_status`) VALUES
(1, 'admin', 'MTIzNDU2', 1, 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(4, '57123250101', 'MTIzNDU2', 2, '57123250101', '2018-04-10', '57123250101', '2018-04-10', 1),
(5, '57123250117', 'MDkxMDM1', 2, '57123250117', '2018-04-10', '57123250117', '2018-04-10', 1),
(6, '60123250123', 'OTgyNTQx', 2, '60123250123', '2018-04-10', '60123250123', '2018-04-10', 1),
(7, '57123250118', 'MTIzNDU2', 2, '57123250118', '2018-04-10', '57123250118', '2018-04-10', 1),
(8, '59123250104', 'MjEyMjI0MjM2', 2, '59123250104', '2018-04-10', '59123250104', '2018-04-10', 1),
(9, '58123250127', 'MTIzNDU2', 2, '58123250127', '2018-04-22', 'admin', '2018-04-23', 1),
(10, '12345678901', 'MTIzNDU2', 1, '12345678901', '2018-05-01', 'admin', '2018-05-01', 1);
...
CREATE TABLE `tblyear` (
  `year_id` int(2) NOT NULL COMMENT 'ลำดับปี',
  `year_name` varchar(4) DEFAULT NULL COMMENT 'ปีการศึกษา',
  `year_names` varchar(2) DEFAULT NULL COMMENT 'ย่อปีการศึกษา',
  `year_createby` varchar(30) DEFAULT NULL COMMENT 'สร้างโดย',
  `year_createtime` date DEFAULT NULL COMMENT 'วันที่สร้าง',
  `year_updateby` varchar(30) DEFAULT NULL COMMENT 'แก้ไขโดย',
  `year_updatetime` date DEFAULT NULL COMMENT 'วันที่แก้ไข',
  `year_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางปีการศึกษา';

--
-- Dumping data for table `tblyear`
--

INSERT INTO `tblyear` (`year_id`, `year_name`, `year_names`, `year_createby`, `year_createtime`, `year_updateby`, `year_updatetime`, `year_status`) VALUES
(1, '2014', '57', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(2, '2015', '58', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(3, '2016', '59', 'admin', '2018-04-09', 'admin', '2018-04-09', 1),
(4, '2017', '60', 'admin', '2018-04-09', 'admin', '2018-04-09', 1);
...
--
-- Indexes for table `tblpreple`
--
ALTER TABLE `tblpreple`
...
ALTER TABLE `tblstudent`
  ...
  ADD KEY `stu_distid` (`stu_distid`),
  ADD KEY `stu_distid_2` (`stu_distid`);

--
-- Indexes for table `tbltittle`
--
ALTER TABLE `tbltittle`
  ADD PRIMARY KEY (`tit_id`);

--
-- Indexes for table `tbltype_education`
--
ALTER TABLE `tbltype_education`
...
--
ALTER TABLE `tblactivity`
  MODIFY `act_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tblbranch`
--
ALTER TABLE `tblbranch`
  MODIFY `bran_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tblcheck`
--
ALTER TABLE `tblcheck`
  MODIFY `chk_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tblcourse`
--
ALTER TABLE `tblcourse`
  MODIFY `cour_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbldegree`
--
ALTER TABLE `tbldegree`
  MODIFY `deg_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tblfaculty`
--
ALTER TABLE `tblfaculty`
  MODIFY `fac_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับคณะ', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbllocation`
--
ALTER TABLE `tbllocation`
  MODIFY `loc_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbltittle`
--
ALTER TABLE `tbltittle`
  MODIFY `tit_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbltype_education`
--
ALTER TABLE `tbltype_education`
  MODIFY `tye_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbluser`
--
ALTER TABLE `tbluser`
  MODIFY `use_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tblyear`
--
ALTER TABLE `tblyear`
  MODIFY `year_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับปี', AUTO_INCREMENT=5;
